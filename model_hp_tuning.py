...
phy_rfr = ScriptRunConfig(
    source_directory=".",  # Directory containing train.py
    script="phy_act_train_rfr.py",
    compute_target="cpu-cluster",
    environment=env,
    docker_runtime_config=docker_config
)

phy_rgb = ScriptRunConfig(
    source_directory=".",  # Directory containing train.py
    script="phy_act_rgb_train.py",
    compute_target="cpu-cluster",
    environment=env,
    docker_runtime_config=docker_config
)
...
cardio_rfr = ScriptRunConfig(
    source_directory=".",  # Directory containing train.py
    script="cardio_train_rfr.py",
    compute_target="cpu-cluster",
    environment=env,
    docker_runtime_config=docker_config
)

cardio_rgb = ScriptRunConfig(
    source_directory=".",  # Directory containing train.py
    script="cardio_rgb_train.py",
    compute_target="cpu-cluster",
    environment=env,
    docker_runtime_config=docker_config
)

runs = [sleep_rfr, sleep_rgb, cardio_rfr, cardio_rgb]
